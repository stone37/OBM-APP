...
class AdvertSubDivisionController extends GetxController with StateMixin<List<Advert>>, SingleGetTickerProviderMixin {
  ...
  getAdverts() async {
    ...
    final response = await AdvertRepository().getAdvertList(
      ...
      brand: (filter['brand'] != null && filter['brand'].isNotEmpty) ? filter['brand'] : null,
