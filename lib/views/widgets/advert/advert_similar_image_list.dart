...
class AdvertSimilarImageList extends StatelessWidget {
  const AdvertSimilarImageList({Key? key, required this.images, required this.controller}) : super(key: key);

  final List<Map<String, dynamic>> images;
  final AdvertSimilarController controller;
