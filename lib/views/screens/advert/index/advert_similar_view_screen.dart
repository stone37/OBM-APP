...
import 'package:obm_market/views/widgets/advert/advert_similar_image_list.dart';
...
class AdvertSimilarViewScreen extends StatelessWidget {
  AdvertSimilarViewScreen({Key? key, required this.advert}) : super(key: key);

  final Advert advert;
  final AuthController authController = Get.find();
  final FavoriteController favoriteController = Get.find();
  final AdvertSimilarController controller = Get.find();
  final UserAdvertController userAdvertController  = Get.find();

  @override
  Widget build(BuildContext context) {

    controller.advertTitle.value = advert.title;
    controller.title.value = advert.title;
                                  ...
                                  return Obx(
                                        ...
                                        child: IconButton(
                                          onPressed: () {
                                            ...
                                            print(favoriteController.saved);
                                          },
                  ...
                  child: Stack(
                    children: <Widget>[
                      InkWell(
                        ...
                        onTap: () {
                          Get.to(() => AdvertSimilarImageList(images: advert.images, controller: controller));
                        },
                                  ...
                                  Row(
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: FaIcon(FontAwesomeIcons.clock, color: AppTheme.primary, size: 12.0),
                                      ),
                                      Text(
  ...
  FutureBuilder _advertiser(AdvertSimilarController controller, UserAdvertController userAdvertController) {
              ...
              Container(
                ...
                child: Material(
                    ...
                    child: InkWell(
                      ...
                      onTap: () => launchUrlString('tel:${advert.user['phone']}'),
                      child: Container(
