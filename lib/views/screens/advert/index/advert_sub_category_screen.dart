...
import '../filter/advert_sub_category_filter_screen.dart';

class AdvertSubCategoryScreen extends StatelessWidget {
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              ...
              advertCategoryController.category.value = controller.categoryParent.value;
