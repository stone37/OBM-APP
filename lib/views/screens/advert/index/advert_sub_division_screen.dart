...
import 'package:obm_market/views/screens/advert/filter/advert_sub_division_filter_screen.dart';
...
class AdvertSubDivisionScreen extends StatelessWidget {
          ...
          leading: IconButton(
            ...
            onPressed: () {
              final Map<String, dynamic> data = {
                'category': controller.categoryParent.value.slug,
                'levelDepth': controller.categoryParent.value.levelDepth,
                'positionOrder': 'desc'};

              controller.initCategory();
              advertSubCategoryController.category.value = controller.categoryParent.value;
                    ...
                    return <Widget>[
                      ...
                      SliverPersistentHeader(
                        ...
                        delegate: ContestTabHeader(
                          _filterBar(controller.category.value, context),
                        ),
                      ),
                    ];
                  },
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    if (authController.connected) {
                      await alertController.add(controller.category.value.id);
                    } else {
