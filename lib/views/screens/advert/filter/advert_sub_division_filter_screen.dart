...
import '../form/marque_screen.dart';
...
class AdvertSubDivisionFilterScreen extends StatelessWidget {

  final GlobalKey<FormState> _formKeys = GlobalKey<FormState>();
  final AdvertSubDivisionController controller = Get.find();
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            splashRadius: 20.0,
            onPressed: () => Get.off(() => AdvertSubDivisionScreen())
          ),
        ),
        body: Container(
                    ...
                    Container(
                      ...
                      child: PageButton(
                        ...
                        callback: () {
                          ...
                          Get.off(() => AdvertSubDivisionScreen());
                        },
                      ),
                    ),
                    Container(
...
class TypeFiel extends StatelessWidget {
  ...
  final AdvertSubDivisionController controller;
        ...
        children: <Widget>[
          ...
          Container(
            child: FormFilterInputData(
              ...
              onTap: () {
                Get.to(() => CityScreen(type: 'filter-sub-division'));
              },
            ),
          ),
          SizedBox(height: 10.0),
          Container(
            child: FormFilterInputData(
              ...
              onTap: () {
                ...
                Get.to(() => ZoneScreen(type: 'filter-sub-division'), arguments: {'name': controller.city.value}) :
        ...
        children: <Widget>[
          Container(
            child: FormFilterInputData(
              ...
              onTap: () {
                Get.to(() => MarqueScreen(type: 'filter-sub-division'));
              },
            ),
          ),
        ],
          ...
          Container(
            child: FormFilterInputData(
              ...
              onTap: () {
                ...
                Get.to(() => ModelScreen(type: 'filter-sub-division'), arguments: {'marque': controller.marque.value}) :
        ...
        children: <Widget>[
          Container(
            child: FormFilterInputData(
              ...
              iconSuffix: FontAwesomeIcons.arrowAltCircleRight,
              onTap: () {
                Get.to(() => TypeCarburantScreen(type: 'filter-sub-division'));
              },
            ),
          ),
        ],
            ...
            children: <Widget>[
              Container(
                  ...
                  child: FormFilterInputData(
                    ...
                    iconSuffix: FontAwesomeIcons.arrowAltCircleRight,
                    onTap: () {
                      Get.to(() => AutoYearScreen(type: 'filter-sub-division', state: 'min'));
                    },
                  )
              ),
              Container(
              ...
              Container(
                ...
                child: FormFilterInputData(
                  ...
                  iconSuffix: FontAwesomeIcons.arrowAltCircleRight,
                  onTap: () {
                    Get.to(() => AutoYearScreen(type: 'filter-sub-division', state: 'max'));
                  },
                ),
              )
            ],
        ...
        children: <Widget>[
          Container(
            child: FormFilterInputData(
              ...
              iconSuffix: FontAwesomeIcons.arrowAltCircleRight,
              onTap: () {
                Get.to(() => NombrePieceScreen(type: 'filter-sub-division'));
              },
            ),
          ),
        ],
        ...
        children: <Widget>[
          Container(
            child: FormFilterInputData(
              ...
              iconSuffix: FontAwesomeIcons.arrowAltCircleRight,
              onTap: () {
                Get.to(() => BrandScreen(type: 'filter-sub-division'));
              },
            ),
          ),
        ],
