...
class AutoStateScreen extends StatelessWidget {
                ...
                Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Flexible(child: _buildAutoStateView(context, getAutoState()))
                        ],
                      ),
                    )
                )
  ...
  Widget _buildAutoStateView(BuildContext context, List<String>? autoStates) {
    ...
    return Theme(
      ...
      child: Column(
        children: <Widget>[
          ListView.builder(
              shrinkWrap: true,
              itemCount: autoStates?.length,
              scrollDirection: Axis.vertical,
              physics: NeverScrollableScrollPhysics(),
              itemBuilder: (BuildContext context, int index) {
                final autoState = autoStates?[index];
                ...
                return Material(
                  ...
                  child: ListTile(
                    ...
                    dense: true,
                    onTap: () {
                      advertCreateController.autoState.value = autoState;
  ...
  List<String>? getAutoState() {
    return AdvertCreateData().autoStateList;
  }
}
