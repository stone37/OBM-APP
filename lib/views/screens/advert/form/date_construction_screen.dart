...
class DateConstructionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Selectionner une date de construction',
            style: TextStyle(
              color: Colors.black,
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Material(
                  ...
                  child: ListTile(
                    ...
                    dense: true,
                    onTap: () {
                      advertCreateController.dateConstruction.value = data;
  ...
  List<String>? getData() {
    return AdvertCreateData().yearConstructionList;
  }
}
