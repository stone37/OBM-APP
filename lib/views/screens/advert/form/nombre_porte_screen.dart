...
class NombrePorteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Selectionner le nombre de porte',
            style: TextStyle(
              color: Colors.black,
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Material(
                  ...
                  child: ListTile(
                    ...
                    dense: true,
                    onTap: () {
                      advertCreateController.nombrePorte.value = data;
  ...
  List<String>? getData() {
    return AdvertCreateData().nombrePorteList;
  }
}
