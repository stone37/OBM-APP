...
class AutoTypeScreen extends StatelessWidget {
                ...
                Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Flexible(child: _buildAutoTypeView(context, getAutoType()))
                        ],
                      ),
                    )
                )
  ...
  Widget _buildAutoTypeView(BuildContext context, List<String>? autoTypes) {
    ...
    return Theme(
      ...
      child: Column(
        children: <Widget>[
          ListView.builder(
              shrinkWrap: true,
              itemCount: autoTypes?.length,
              scrollDirection: Axis.vertical,
              physics: NeverScrollableScrollPhysics(),
              itemBuilder: (BuildContext context, int index) {
                final autoType = autoTypes?[index];
                ...
                return Material(
                  ...
                  child: ListTile(
                    ...
                    dense: true,
                    onTap: () {
                      advertCreateController.autoType.value = autoType;
  ...
  List<String>? getAutoType() {
    return AdvertCreateData().autoTypeList;
  }
}
