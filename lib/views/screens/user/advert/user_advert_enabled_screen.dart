...
class UserAdvertEnabledScreen extends StatelessWidget {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      FutureBuilder<List<Advert>>(
                        future: controller.getUserAdvertEnabled(),
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        'C\'est ici que vous verrez toutes vos annonces qui sont visibles par les acheteurs.',
                                        style: TextStyle(
                                          fontSize: 14,
  ...
  Widget _buildAdvertView(UserAdvertController controller, BuildContext context, List<Advert>? adverts) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          controller.advertId.add(advert.id);

          return UserAdvertView(advert: advert, controller: controller, state: true);
        }
    );
  }
}
