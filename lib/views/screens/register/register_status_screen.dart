...
class RegisterStatusScreen extends StatelessWidget {
  const RegisterStatusScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        'Veuillez vérifier votre adresse e-mail ${box.read('user_email')} pour confirmer votre compte.',
                        ...
                        children: [
                          Container(
                            ...
                            child: PageButton(
                              ...
                              callback: () => Get.to(() => RegisterScreen())
                            ),
                          ),
                          Container(
